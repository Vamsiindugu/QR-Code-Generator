...
import QRCode from 'react-qr-code'; // Actual dependency import
...
const GeneratorSection = () => {
  ...
  const sectionVariants = {
    ...
    const handleDownload = () => {
      ...
      const borderRadius = 24; // For rounded corners
  ...
  const handleShare = async () => {
    ...
    try {
      await navigator.share({
        ...
        text: `Check out this QR code I generated with content: ${qrContent}`,
  ...
  // Style for the QR code background/foreground based on theme
  ...
  return (
    <motion.section
      id="generator"
      className="min-h-screen bg-gray-50 dark:bg-gray-800 transition-colors duration-500 p-8 md:p-16 lg:p-20"
      initial="hidden"
      whileInView="visible"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
        ...
        <div className="lg:order-1 order-2">
          ...
          <textarea
            ...
            className="w-full p-4 border-2 border-gray-300 dark:border-gray-600 rounded-xl resize-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white transition-colors duration-300 text-lg font-mono"
          />
        ...
        <div className="lg:order-2 order-1 flex flex-col items-center justify-center bg-white dark:bg-gray-700 p-8 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-600">
    ...
    <Button 
        ...
        className="flex-1 max-w-[150px]" // Added for better width control
    >
        Download
    </Button>
